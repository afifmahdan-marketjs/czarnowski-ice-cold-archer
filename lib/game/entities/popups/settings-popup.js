    ...
    .defines(function () {
        EntitySettingsPopup = EntityPopup.extend({
            ...
            init: function (x, y, settings) {
                ...
                this.title = this.spawnMember(EntityTextField, baseX + 15, baseY - 70, { zIndex: 7000, anchorX: 0.5, anchorY: 0.5, text: _STRINGS.Game.Settings, font: "64px titlefont", align: "center", color: "#ffffff", entryType: "fadeIn", exitType: "fadeOut" })
