  ...
  .defines(function () {
    EntitySettingsPopup = EntityPopup.extend({
      ...
      init: function (x, y, settings) {
        ...
        var bg = this.spawnMember(EntityGameObject, 540, 960, {
          image: this.bgImg,
          anchorX: 0.5,
          anchorY: 0.5,
          entryType: "fadeIn",
        ...
        this.homeButton = this.spawnMember(
          EntitySimpleButton,
          baseX,
          baseY + 130,
          { image: this.homeBtnImg, entryType: "fadeIn", exitType: "fadeOut" }
        );
        this.homeButton.onClicked.addOnce(this.onClickHome, this);

        this.bgmButton = this.spawnMember(
          EntitySimpleButton,
          baseX,
          baseY - 80,
          {
            image: this.toggleOnImg,
            text: "",
            font: "36px mainfont",
            align: "center",
            color: "#ffffff",
        ...
        this.sfxButton = this.spawnMember(
          EntitySimpleButton,
          baseX,
          baseY + 20,
          {
