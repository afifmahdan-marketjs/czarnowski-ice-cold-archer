    ...
    .defines(function () {
        EntityPausePopup = EntitySettingsPopup.extend({
            ...
            init: function (x, y, settings) {
                ...
                this.replayButton = this.spawnMember(EntitySimpleButton, 270 + 120, this.homeButton.anchoredPositionY, { usePressedTween: true, image: this.replayBtnImg, anchorX: 0.5, anchorY: 0.5, entryType: "fadeIn", exitType: "fadeOut", entryDuration: 0.25, exitDuration: 0.25 });
                this.replayButton.onClicked.addOnce(this.onClickReplay, this)
                this.homeButton.anchoredPositionX = 270 - 120;
