ig.module("game.entities.popups.pause-popup")
  .requires("game.entities.popups.settings-popup")
  .defines(function () {
    EntityPausePopup = EntitySettingsPopup.extend({
      ...
      init: function (x, y, settings) {
        ...
        this.resumeButton = this.spawnMember(
          EntitySimpleButton,
          540,
          this.homeButton.anchoredPositionY,
          {
            usePressedTween: true,
            image: this.resumeBtnImg,
            anchorX: 0.5,
            anchorY: 0.5,
            entryType: "fadeIn",
            exitType: "fadeOut",
        ...
        this.replayButton = this.spawnMember(
          EntitySimpleButton,
          540 + 240,
          this.homeButton.anchoredPositionY,
          {
            usePressedTween: true,
            image: this.replayBtnImg,
            anchorX: 0.5,
            anchorY: 0.5,
            entryType: "fadeIn",
            exitType: "fadeOut",
        ...
        this.homeButton.anchoredPositionX = 540 - 240;
      ...
      onClickHome: function () {
        ...
        try {
          ig.linkit360Skill.trackGameInterrupted(ig.lastScore);
        } catch(error) {}
        console.log(ig.lastScore);
      },
      ...
      onClickResume: function () {
        ...
        /** Linkit360 Skill - trackGameResumed */
        try {
          ig.linkit360Skill.trackGameResumed();
        } catch(error) {}
      },
      ...
      onClickReplay: function () {
        ...
        try {
          ig.linkit360Skill.trackGameRestarted();
        } catch(error) {}
      },
    });
  });
