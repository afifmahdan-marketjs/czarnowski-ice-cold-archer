    ...
    .defines(function () {
        EntityMainMenuController = EntityController.extend({
            ...
            init: function (x, y, settings) {
                ...
                ig.meshManager.redrawTexts();
                ig.game.spawnEntity(EntityGameObject, 270, 250, { image: this.titleImage, entryType: "fadeIn", exitType: "fadeOut", anchorX: 0.5, anchorY: 0.5 });
                ...
                var settingsButton = ig.game.spawnEntity(EntitySimpleButton, 270 + 140, 650, { image: this.settingsBtnImage, entryType: "fadeIn", exitType: "fadeOut" });
                settingsButton.onClicked.add(this.onClickSettings, this);

                if (_SETTINGS.MoreGames.Enabled) {
                    var moreGamesButton = ig.game.spawnEntity(EntitySimpleButton, 270 - 140, 650, { image: this.moreGamesBtnImage, entryType: "fadeIn", exitType: "fadeOut" });
                ...
                this.fullscreenbtn = ig.game.spawnEntity(ig.FullscreenButton, -20 - 62, 20, {
