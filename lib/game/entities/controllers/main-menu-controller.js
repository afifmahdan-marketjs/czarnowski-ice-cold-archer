    ...
    .defines(function () {
        EntityMainMenuController = EntityController.extend({
            ...
            init: function (x, y, settings) {
                ...
                this.title = ig.game.spawnEntity(EntityGameObject, 270, 320, { image: this.titleImage, entryType: "fadeIn", exitType: "fadeOut", anchorX: 0.5, anchorY: 0.5 });
                ...
                var playButton = ig.game.spawnEntity(EntitySimpleButton, 270, 650, { image: this.playBtnImage, entryType: "fadeIn", exitType: "fadeOut" });
                playButton.onClicked.add(this.onClickPlay, this);

                var settingsButton = ig.game.spawnEntity(EntitySimpleButton, 270 + 180, 650, { image: this.settingsBtnImage, entryType: "fadeIn", exitType: "fadeOut" });
                settingsButton.onClicked.add(this.onClickSettings, this);

                if (_SETTINGS.MoreGames.Enabled) {
                    var moreGamesButton = ig.game.spawnEntity(EntitySimpleButton, 270 - 180, 650, { image: this.moreGamesBtnImage, entryType: "fadeIn", exitType: "fadeOut" });
                    ...
                    settingsButton.anchoredPositionX = 270;
                    settingsButton.anchoredPositionY = 800;
                }

                this.fullscreenbtn = ig.game.spawnEntity(ig.FullscreenButton, -120, 20, {
            ...
            onClickPlay: function () {
                ig.soundHandler.sfxPlayer.play(ig.soundHandler.sfxPlayer.soundList.click);
                ig.soundHandler.sfxPlayer.stop(ig.soundHandler.sfxPlayer.soundList.bgmMainMenu);
            ...
            update: function () {
                ...
                if (this.clickableLayer) {
                    ...
                    this.clickableLayer.update(btn.pos.x - btn.width / 2, btn.pos.y - btn.height / 2, btn.width, btn.height);
                }
            },
