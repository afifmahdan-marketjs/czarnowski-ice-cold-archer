  ...
  .defines(function () {
    EntityGameOverController = EntityController.extend({
      ...
      init: function (x, y, settings) {
        ...
        ig.game.spawnEntity(EntityTextField, 540, 196 + 590, {
          font: "48px mainfont",
        ...
        ig.game.spawnEntity(EntityTextField, 540, 250 + 590, {
          font: "26px contentfont",
        ...
        ig.game.spawnEntity(EntityTextField, 540, 310 + 590, {
          font: "64px mainfont",
          text: "" + currentScore,
          align: "center",
          entryType: "fadeIn",
        ...
        ig.game.spawnEntity(EntityTextField, 540, 360 + 590, {
          font: "26px contentfont",
        ...
        ig.game.spawnEntity(EntityTextField, 540, 410 + 590, {
          font: "48px mainfont",
