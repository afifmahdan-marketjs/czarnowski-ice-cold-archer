    ...
    .defines(function () {
        EntityGameOverController = EntityController.extend({
            ...
            init: function (x, y, settings) {
                ...
                ig.game.spawnEntity(EntityTextField, 270, 250, { font: "72px titlefont", text: _STRINGS.Game.GameOver, align: "center", entryType: "fadeIn", exitType: "fadeOut" });
                // API_END_GAME
                var currentScore = Math.round(ig.gameScene3D.player.score);
