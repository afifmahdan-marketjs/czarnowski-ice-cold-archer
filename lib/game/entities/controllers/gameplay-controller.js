    ...
    .defines(function () {
        EntityGameplayController = EntityController.extend({
            ...
            askForRevive: function () {
                this.rvUISet = [];
                var bg = ig.game.spawnEntity(EntityGameObject, 270, 480, { anchorX: 0.5, anchorY: 0.5, image: this.popupBgImg, entryType: "fadeIn", exitType: "fadeOut" });
                var title = ig.game.spawnEntity(EntityTextField, 270, 326, { font: "48px mainfont", text: _STRINGS.Game.Continue, color: "#000000", align: "center", entryType: "fadeIn", exitType: "fadeOut" });
                var confirmation = ig.game.spawnEntity(EntityTextField, 270, 450, { font: "32px mainfont", lineSpacing: 1.5, text: _STRINGS.Game.Revive, color: "#000000", align: "center", entryType: "fadeIn", exitType: "fadeOut" });
                var yes = ig.game.spawnEntity(EntitySimpleButton, 270 - 87, 625, { image: this.yesBtnImage, font: "36px mainfont", text: _STRINGS.Game.Yes, textColor: "#000000", offsetX: 14, offsetY: -7, entryType: "fadeIn", exitType: "fadeOut" });
                yes.onClicked.add(this.onClickRevive, this);

                var no = ig.game.spawnEntity(EntitySimpleButton, 270 + 87, yes.anchoredPositionY, { image: this.noBtnImage, font: "36px mainfont", text: _STRINGS.Game.No, textColor: "#000000", offsetY: -7, entryType: "fadeIn", exitType: "fadeOut" });
            ...
            rewardedVideoResult: function (isSuccess) {
                ...
                if (isSuccess) {
                    this.showRVNotification(_STRINGS.Game.Reward, _STRINGS.Game.RewardSuccess, _STRINGS.Game.Sweet, function () {
                        this.clearRvUISet();
                        this.doRevive();
                    }.bind(this))
                } else {
                    this.showRVNotification(_STRINGS.Game.Reward, _STRINGS.Game.RewardFail, _STRINGS.Game.Okay, function () {
                        this.clearRvUISet();
                        this.goToGameOver();
                    }.bind(this))
                }
            ...
            showRVNotification: function (titleText, messageText, buttonText, callback) {
                var bg = ig.game.spawnEntity(EntityGameObject, 270, 480, { anchorX: 0.5, anchorY: 0.5, image: this.popupBgImg, entryType: "fadeIn", exitType: "fadeOut" });
                var title = ig.game.spawnEntity(EntityTextField, 270, 324, { font: "36px mainfont", text: titleText, color: "#000000", align: "center", entryType: "fadeIn", exitType: "fadeOut" });
                var confirmation = ig.game.spawnEntity(EntityTextField, 270, 450, { font: "32px mainfont", text: messageText, color: "#000000", align: "center", entryType: "fadeIn", exitType: "fadeOut" });

                var yes = ig.game.spawnEntity(EntitySimpleButton, 270, 625, { image: this.simpleBtnImage, font: "36px mainfont", text: buttonText, textColor: "#000000", offsetY: -7, entryType: "fadeIn", exitType: "fadeOut" });
                yes.onClicked.add(function () {
                    this.clearRvUISet();
