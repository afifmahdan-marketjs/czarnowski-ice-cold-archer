ig.module("game.entities.controllers.gameplay-controller")
  ...
  .defines(function () {
    EntityGameplayController = EntityController.extend({
      ...
      yesBtnImage: new ig.Image("media/graphics/game/yes-btn.png"),
      noBtnImage: new ig.Image("media/graphics/game/no-btn.png"),
      simpleBtnImage: new ig.Image("media/graphics/game/button-on.png"),
      ...
      init: function (x, y, settings) {
        ...
        this.score = 0;
        this.scoreTf = ig.game.spawnEntity(EntityTextField, 0, 180, {
          font: "172px mainfont",
          text: "0",
          align: "center",
          color: "#000000",
        ...
        this.tutorialTf = ig.game.spawnEntity(EntityTextField, 0, -200, {
          font: "56px contentfont",
          text: _STRINGS.Game.Tutorial,
          lineSpacing: 1.5,
          align: "center",
          color: "#ffbc42",
          outlineColor: "#000000",
        ...
        this.aimTimeTf = ig.game.spawnEntity(
          EntityTextField,
          0,
          this.aimTimeTextDistance,
          {
            font: "56px contentfont",
            text: "",
            align: "center",
        ...
        this.arrowBg = ig.game.spawnEntity(EntityGameObject, 20, 20, {
          image: this.arrowBgImage,
          anchorType: "top-left",
          anchorX: 0,
          anchorY: 0,
          entryType: "fadeIn",
        ...
        for (var i = 0; i < this.arrowLeft; i++) {
          var arrow = ig.game.spawnEntity(EntityGameObject, 40 + i * 64, 72, {
        ...
        this.windBg = ig.game.spawnEntity(EntityGameObject, 260, -110, {
          image: this.windBgImage,
          anchorType: "bottom-left",
          anchorX: 0.5,
          anchorY: 1,
          alpha: 0,
        });
        this.windIcon = ig.game.spawnEntity(EntityGameObject, 280, -220, {
          image: this.windIconImage,
          anchorType: "bottom-left",
          //scaleX: 0.35,
          //scaleY: 0.35,
          anchorX: 0.5,
        ...
        this.pauseButton = ig.game.spawnEntity(EntitySimpleButton, -160, 160, {
          anchorType: "top-right",
          image: this.pauseImage,
          entryType: "fadeIn",
          exitType: "fadeOut",
          anchorX: 0.5,
          anchorY: 0.5,
      ...
      onArrowLanded: function () {
        ...
        ig.game.spawnEntity(EntityScoreFx, 0, 0, {
          ...
          callback: function () {
            ...
            /** Linkit360 Skill - trackGameScore */
            try {
              ig.linkit360Skill.trackGameScore(this.score);
            } catch(error) {}
          }.bind(this),
        });
        ...
        this.delayedCall(
          ...
          function () {
            if (this.arrowLeft > 0) {
              ...
              /** Linkit360 Skill - trackUserAction */
                try {
                  ig.linkit360Skill.trackUserAction("shoot");
              } catch(error) {}
            } else {
              this.delayedCall(
                2,
      ...
      askForRevive: function () {
        this.rvUISet = [];
        var bg = ig.game.spawnEntity(EntityGameObject, 540, 960, {
          anchorX: 0.5,
          anchorY: 0.5,
          image: this.popupBgImg,
          entryType: "fadeIn",
          exitType: "fadeOut",
        });
        var title = ig.game.spawnEntity(EntityTextField, 540, 610, {
          font: "96px mainfont",
        ...
        var confirmation = ig.game.spawnEntity(EntityTextField, 540, 930, {
          font: "72px mainfont",
          lineSpacing: 1.5,
          text: _STRINGS.Game.Revive,
          color: "#000000",
          align: "center",
          entryType: "fadeIn",
          exitType: "fadeOut",
        });
        var yes = ig.game.spawnEntity(EntitySimpleButton, 540 - 185, 1250, {
          image: this.yesBtnImage,
          font: "72px mainfont",
        ...
        yes.onClicked.add(this.onClickRevive, this);

        var no = ig.game.spawnEntity(
          EntitySimpleButton,
          540 + 185,
          yes.anchoredPositionY,
          {
            image: this.noBtnImage,
            font: "72px mainfont",
        ...
        no.onClicked.add(this.onClickNoRevive, this);

        this.rvUISet.push(bg, title, confirmation, yes, no);
      },

      clearRvUISet: function () {
        for (var i = 0; i < this.rvUISet.length; i++) {
          var item = this.rvUISet[i];
          item.exit();
        }
      },
      ...
      showRVNotification: function (
        titleText,
        messageText,
        buttonText,
        callback
      ) {
        var bg = ig.game.spawnEntity(EntityGameObject, 270, 480, {
          anchorX: 0.5,
          anchorY: 0.5,
          image: this.popupBgImg,
          entryType: "fadeIn",
        ...
        var title = ig.game.spawnEntity(EntityTextField, 270, 324, {
          font: "36px mainfont",
          text: titleText,
          color: "#000000",
          align: "center",
        ...
        var confirmation = ig.game.spawnEntity(EntityTextField, 270, 450, {
          font: "32px mainfont",
          text: messageText,
          color: "#000000",
          align: "center",
        ...
        var yes = ig.game.spawnEntity(EntitySimpleButton, 270, 625, {
          image: this.simpleBtnImage,
          font: "36px mainfont",
          text: buttonText,
          textColor: "#000000",
          offsetY: -7,
        ...
        this.rvUISet.push(bg, title, confirmation, yes);
      },
      ...
      goToGameOver: function () {
        ...
        ig.soundHandler.sfxPlayer.play(
          ig.soundHandler.sfxPlayer.soundList.crowdApplause
        );
      },
      ...
      onClickPause: function () {
        ...
        /** Linkit360 Skill - trackGamePaused */
        try {
          ig.linkit360Skill.trackGamePaused();
        } catch(error) {}
      },
      ...
      update: function () {
        ...
        if (
          windX != 0 &&
          (ig.babylonSceneController.arrow.isRelaxing ||
            ig.babylonSceneController.arrow.isAiming)
        ) {
          ...
          if (this.windFxSpawnDelay > 0) {
            ...
            ig.game.spawnEntity(
              EntityWindFx,
              this.windIcon.anchoredPositionX +
                (windX < 0 ? windSwing : -windSwing),
              this.windIcon.anchoredPositionY + 10,
              { killDistance: windSwing * 2 }
            );
            var spawnX = ig.random.float(
              0,
              windX > 0
                ? -ig.meshManager.stripeWidth / 2
                : ig.meshManager.stripeWidth / 2
            );
            var spawnY = ig.random.float(
              ig.meshManager.targetHeight * 0.5,
              ig.meshManager.targetHeight * 3
            );
            var spawnZ = ig.random.float(
              ig.meshManager.targetDistance * 0.2,
              ig.meshManager.targetDistance
            );
        ...
        if (this.allowShooting && ig.babylonSceneController.arrow.isRelaxing) {
          if (isTouching) {
            ...
            if (!this.isAiming) {
              ...
              this.aimCenterX =
                touchX + ig.random.int(-aimCenterRandom, aimCenterRandom);
              this.aimCenterY =
                touchY + ig.random.int(-aimCenterRandom, aimCenterRandom);
              this.crosshairX =
                ig.random.int(
                  -this.crosshairStartAimRadius,
                  this.crosshairStartAimRadius
                ) * 2;
              this.crosshairY =
                ig.random.int(
              ...
              ig.soundHandler.sfxPlayer.play(
                ig.soundHandler.sfxPlayer.soundList[
                  "bowDraw" + ig.random.int(1, 5)
                ]
              );
            }
            this.isAiming = true;
            ...
            var dt = ig.system.tick;
            var aimChaseSpeedX =
              (this.aimControlX - this.aimCenterX) *
              dt *
              this.crosshairSpeedMultiplier;
            var aimChaseSpeedY =
              (this.aimCenterY - this.aimControlY) *
              dt *
              this.crosshairSpeedMultiplier;

            var speedLengthSquared =
              aimChaseSpeedX * aimChaseSpeedX + aimChaseSpeedY * aimChaseSpeedY;
            ...
            if (speedLengthSquared < minimumSpeed * minimumSpeed) {
              var normalized = ig.utils.normalize2(
                aimChaseSpeedX,
                aimChaseSpeedY,
                minimumSpeed
              );
            ...
            if (this.crosshairX < -this.crosshairAreaRadius)
              this.crosshairX = -this.crosshairAreaRadius;
            if (this.crosshairX > this.crosshairAreaRadius)
              this.crosshairX = this.crosshairAreaRadius;

            if (this.crosshairY < -this.crosshairAreaRadius)
              this.crosshairY = -this.crosshairAreaRadius;
            if (this.crosshairY > this.crosshairAreaRadius)
              this.crosshairY = this.crosshairAreaRadius;

            if (this.crosshairY < -700) this.crosshairY = -700;
            ...
            ig.meshManager.crosshairPoint.position.x =
              0 + this.crosshairX * this.cameraPositionRatio;
            ig.meshManager.crosshairPoint.position.y =
              ig.meshManager.targetHeight +
              this.crosshairY * this.cameraPositionRatio;
            // if (ig.meshManager.crosshairPoint.position.y < 5)
            //   ig.meshManager.crosshairPoint.position.y = 5;
      ...
      draw: function () {
        ...
        if (this.isAiming) {
          ...
          if (timePercent > 0.01) {
            ...
            ctx.beginPath();
            ctx.arc(0, 0, this.aimTimeTextDistance + 40, startAngle, endAngle);
