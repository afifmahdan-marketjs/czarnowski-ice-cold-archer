  ...
  .defines(function () {
    EntityGameplayController = EntityController.extend({
      ...
      init: function (x, y, settings) {
        ...
        this.tutorialTf = ig.game.spawnEntity(EntityTextField, 0, -110, {
          font: "28px contentfont",
        ...
        this.windBg = ig.game.spawnEntity(EntityGameObject, 150, -110, {
        ...
        this.windIcon = ig.game.spawnEntity(EntityGameObject, 150, -150, {
        ...
        this.pauseButton = ig.game.spawnEntity(EntitySimpleButton, -70, 70, {
      ...
      askForRevive: function () {
        ...
        var title = ig.game.spawnEntity(EntityTextField, 540, 790, {
          font: "48px mainfont",
        ...
        var yes = ig.game.spawnEntity(EntitySimpleButton, 540 - 87, 1100, {
