    ...
    .defines(function () {
        EntityGameplayController = EntityController.extend({
            ...
            init: function (x, y, settings) {
                ...
                this.score = 0;
                this.scoreTf = ig.game.spawnEntity(EntityTextField, 0, 120, { font: "100px mainfont", text: "0", align: "center", color: "#000000", entryType: "fadeIn", exitType: "fadeOut", anchorType: "top", entryDelay: 0.5 });
                ...
                if (this.allowShooting && ig.babylonSceneController.arrow.isRelaxing) {
                    if (isTouching) {
                        ...
                        if (!this.isAiming) {
                            ...
                            ig.soundHandler.sfxPlayer.play(ig.soundHandler.sfxPlayer.soundList.bowDraw);
                        }
                        this.isAiming = true;
                        ...
                        if (this.isAiming) {
                            ...
                            ig.soundHandler.sfxPlayer.play(ig.soundHandler.sfxPlayer.soundList.bowRelease);
                            this.aimTime = this.aimTimeMax;
                        }
                    }
                }
