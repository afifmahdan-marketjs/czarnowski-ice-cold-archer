ig.module("game.scene3d.utils.camera-control")
  .requires()
  .defines(function () {
    "use strict";
    ig.cameraControl = {
      ...
      pointCameraToVec3: function (vec3, dt, instant) {
        ...
        if (instant) {
          ...
          if (vec3.z > ig.meshManager.targetDistance + 20)
            vec3.z = ig.meshManager.targetDistance + 20;
          if (vec3.y < ig.meshManager.targetHeight / 2)
            vec3.y = ig.meshManager.targetHeight / 2;
