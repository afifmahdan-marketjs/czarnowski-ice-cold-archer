    ...
    .defines(function () {
        ...
        ig.meshManager = {
            ...
            initTarget: function () {
                ...
                this.target = BABYLON.MeshBuilder.CreateCylinder("target", { diameter: 15, height: 3, tessellation: 64, faceUV: targetFaceUV, faceColors: targetFaceColors }, scene);
            ...
            initArrow: function () {
                ...
                this.arrowBody = BABYLON.MeshBuilder.CreateBox("arrowBody", { width: 0.1, height: 0.1, depth: 10 }, scene);
