    ...
    ig.SplashLoader = ig.Loader.extend({
      ...
      draw: function () {
        ...
        this.titleImage.draw(
          drawPoint.x + 540 - this.titleImage.width / 2,
          drawPoint.y + 700 - this.titleImage.height / 2
        );
        ...
        if (!ig.babylonJSSupport) {
          ...
          ctx.strokeText("UNABLE TO RUN GAME", drawPoint.x + 540, 760);
          ctx.fillText("UNABLE TO RUN GAME", drawPoint.x + 540, 760);
        ...
        if (!ig.altBabylon.scene && this._drawStatus > 0.95)
          this._drawStatus = 0.95;
      ...
      drawVersion: function () {
        if (
          typeof _SETTINGS.Versioning !== "undefined" &&
          _SETTINGS.Versioning !== null
        ) {
