        ...
        ig.SizeHandler.inject({
            ...
            sizeCalcs: function () {
                if (!this.originalResolution) {
                    this.originalResolution = new BABYLON.Vector2(this.desktop.actualResolution.x, this.desktop.actualResolution.y);
                ...
                var newWidth = 0;
                var newHeight = 0;
                this.windowSize = new BABYLON.Vector2(innerWidth, innerHeight);
                ...
                this.scaleRatioMultiplier = new BABYLON.Vector2(innerWidth / newWidth, innerHeight / newHeight);
                this.desktop.actualResolution = new BABYLON.Vector2(newWidth, newHeight);
                this.mobile.actualResolution = new BABYLON.Vector2(newWidth, newHeight);
                this.desktop.actualSize = new BABYLON.Vector2(innerWidth, innerHeight);
                this.mobile.actualSize = new BABYLON.Vector2(innerWidth, innerHeight);
            ...
            resizeBabylon: function () {
                ...
                var engine = null;
                if (window.wgl && wgl.system && wgl.system.engine) engine = wgl.system.engine;
                if (ig.altBabylon) engine = ig.altBabylon.engine;

                engine.setSize(w, h);
                engine.resize();
                engine.setHardwareScalingLevel(Math.max(renderRatioW, renderRatioH));
                ...
                */
                ...
                console.log(
                    "babylon renderSize : ", engine.getRenderWidth(), engine.getRenderHeight(),
                    "hwScalingLevel : ", engine.getHardwareScalingLevel().toFixed(2));
            }
