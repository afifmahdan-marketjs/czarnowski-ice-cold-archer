  ...
  .defines(function () {
    ig.SizeHandler = ig.Class.extend({
      ...
      desktop: {
        ...
        actualResolution: new BABYLON.Vector2(1080, 1920),
      },
      ...
      sizeCalcs: function () {
        ...
        if (ig.ua.mobile) {
          ...
          var desktopTempSize = new Vector2(
            this.desktop.actualResolution.x,
            this.desktop.actualResolution.y
          );

          this.scaleRatioMultiplier = new Vector2(
            this.desktop.actualSize.x / desktopTempSize.x,
      ...
      resizeLayers: function (width, height) {
        ...
        for (var key in this.adsToResize) {
          ...
          var divLeft =
            (window.innerWidth - this.adsToResize[key]["box-width"]) / 2 + "px";
          var divTop =
            (window.innerHeight - this.adsToResize[key]["box-height"]) / 2 +
            "px";
        ...
        for (var key in this.dynamicClickableEntityDivs) {
          ...
          if (ig.ua.mobile) {
            ...
            if (this.disableStretchToFitOnMobileFlag) {
              var divleft =
                Math.floor(offsetLeft + posX * this.scaleRatioMultiplier.x) +
                "px";
              var divtop =
                Math.floor(offsetTop + posY * this.scaleRatioMultiplier.y) +
                "px";
              var divwidth =
                Math.floor(sizeX * this.scaleRatioMultiplier.x) + "px";
              var divheight =
                Math.floor(sizeY * this.scaleRatioMultiplier.y) + "px";
            } else {
      ...
      resizeAds: function () {
        for (var key in this.adsToResize) {
          ...
          var divLeft =
            ((window.innerWidth - this.adsToResize[key]["box-width"]) >> 1) +
            "px";
          var divTop =
            ((window.innerHeight - this.adsToResize[key]["box-height"]) >> 1) +
            "px";
      ...
      samsungFix: function () {
        ...
        if (
          ...
          return; //if android under 4.2 return
