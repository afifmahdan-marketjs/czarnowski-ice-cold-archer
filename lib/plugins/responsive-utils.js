        ...
        ig.responsive = {
            ...
            toAnchor: function (x, y, type) {
                switch (type) {
                    ...
                    case "right-middle": case "middle-right": case "right": return toAnchorRightMiddle(x, y);
            ...
            toAnchorDefault: function (x, y) {
                return { x: x + (this.width - this.originalResolution.x) / 2, y: y + (this.height - this.originalResolution.y) / 2 };
            },
