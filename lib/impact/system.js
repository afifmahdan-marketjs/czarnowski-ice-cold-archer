...
ig.System = ig.Class.extend({
	...
	clear: function( color ) {
        ...
        /** Alternative for Samsung Tab, this is the only hack
        * Added by Justin Ng Wei Shung, hopefully you will never need to use this
        *
	    clearCanvas1:function(canvas,ctx,width,height){
